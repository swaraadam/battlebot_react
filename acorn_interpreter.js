...
Interpreter.prototype.initObject = function(a) {
    var b = this,
        c;
    c = function(a) {
        if (!a || a == b.UNDEFINED || a == b.NULL) return this.parent == b.OBJECT ? this : b.createObject(b.OBJECT);
        if (a.isPrimitive) {
    ...
    c = function(a) {
        var c = b.createObject(b.ARRAY),
            d = 0,
            p;
        for (p in a.properties) a.notEnumerable[p] || (b.setProperty(c, d, b.createPrimitive(p)), d++);
        return c
    };
    ...
    c = function(a) {
        for (;;)
            if (a.parent && a.parent.properties && a.parent.properties.prototype) {
                if (a = a.parent.properties.prototype, a == this) return b.createPrimitive(!0)
...
Interpreter.prototype.initArray = function(a) {
    ...
    d = function(a) {
        var c = this.parent == b.ARRAY ? this : b.createObject(b.ARRAY),
            d = arguments[0];
        if (d && "number" == d.type) isNaN(b.arrayIndex(d)) && b.throwException(b.RANGE_ERROR, "Invalid array length"), c.length = d.data;
        else {
    ...
    d = function(a, d) {
        ...
        for (d = Math.max(0, d); d < this.length; d++) {
            ...
            if (h.isPrimitive && a.isPrimitive ? h.data === a.data : h === a) return b.createPrimitive(d)
        }
...
Interpreter.prototype.initString = function(a) {
    ...
    }(String.prototype[a[d]]), this.setNativeFunctionPrototype(this.STRING, a[d], c);
    c = function() {
        var a = this.toString();
    ...
    for (d = 0; d < a.length; d++) c = function(a) {
        return function() {
            for (var c = 0; c < arguments.length; c++) arguments[c] = arguments[c].toNumber();
...
Interpreter.prototype.initDate = function(a) {
    ...
    c = function(a, c, d, r, v, w, q) {
        ...
        if (arguments.length)
            if (1 != arguments.length || "string" != a.type && !b.isa(a, b.STRING)) {
                for (var h = [null], p = 0; p < arguments.length; p++) h[p + 1] = arguments[p] ? arguments[p].toNumber() : void 0;
    ...
    for (var d = 0; d < a.length; d++) c = function(a) {
        return function(c) {
            for (var d = [], g = 0; g < arguments.length; g++) d[g] = b.pseudoToNative(arguments[g]);
            return b.createPrimitive(this.data[a].apply(this.data, d))
        }
    }(a[d]), this.setNativeFunctionPrototype(this.DATE, a[d], c)
};
...
Interpreter.prototype.comp = function(a, b) {
    if (a.isPrimitive && isNaN(a.data) || b.isPrimitive && isNaN(b.data)) return NaN;
    if (a === b) return 0;
...
Interpreter.prototype.nativeToPseudo = function(a) {
    if ("boolean" == typeof a || "number" == typeof a || "string" == typeof a || null === a || void 0 === a || a instanceof RegExp) return this.createPrimitive(a);
    var b;
    if (a instanceof Array) {
        b = this.createObject(this.ARRAY);
        for (var c = 0; c < a.length; c++) this.setProperty(b, c, this.nativeToPseudo(a[c]))
    } else
        for (c in b = this.createObject(this.OBJECT), a) this.setProperty(b, c, this.nativeToPseudo(a[c]));
    return b
};
Interpreter.prototype.pseudoToNative = function(a) {
    if (a.isPrimitive || this.isa(a, this.NUMBER) || this.isa(a, this.STRING) || this.isa(a, this.BOOLEAN)) return a.data;
    var b;
    if (this.isa(a, this.ARRAY)) {
        b = [];
        for (var c = 0; c < a.length; c++) b[c] = this.pseudoToNative(a.properties[c])
    } else
        for (c in b = {}, a.properties) b[c] = this.pseudoToNative(a.properties[c]);
    return b
};
...
Interpreter.prototype.throwException = function(a, b) {
    if (this.stateStack[0].interpreter) try {
        this.stateStack[0].interpreter.throwException(a, b);
        return
    } catch (c) {}
    void 0 !== b && (a = this.createObject(a), this.setProperty(a, "message", this.createPrimitive(b), Interpreter.NONENUMERABLE_DESCRIPTOR));
...
Interpreter.prototype.stepArrayExpression = function() {
    ...
    c < b.elements.length ? (a.n = c + 1, b.elements[c] ? this.stateStack.unshift({
        node: b.elements[c]
    }) : a.value = void 0) : (a.array.length = a.n || 0, this.stateStack.shift(), this.stateStack[0].value = a.array)
};
    ...
    if (a.doneLeft)
        if (a.doneRight)
            if (a.doneSetter_) this.stateStack.shift(), this.stateStack[0].value = a.doneSetter_;
                ...
                }(c = this.setValue(a.leftSide, b)) ? (a.doneSetter_ = b, this.stateStack.unshift({
                    node: {
                        type: "CallExpression"
                    },
                    doneCallee_: !0,
        ...
        if (!a.doneGetter_ && "=" != b.operator && (a.leftValue = this.getValue(a.leftSide), a.leftValue.isGetter)) {
    ...
    if (a.doneCallee_) {
        ...
        if (a.doneExec_) this.stateStack.shift(), this.stateStack[0].value = a.isConstructor_ && "object" !== a.value.type ? a.funcThis_ : a.value;
            ...
            for (var b = this.createScope(a.func_.node.body,
                    a.func_.parentScope), c = 0; c < a.func_.node.params.length; c++) {
            ...
            this.paused_ = !0
        } else if (a.func_.eval)(b = a.arguments[0]) ? b.isPrimitive ? (b = new Interpreter(b.toString()), b.stateStack[0].scope = this.getScope(), a = {
            node: {
                type: "Eval_"
            },
            interpreter: b
...
Interpreter.prototype.stepLogicalExpression = function() {
    var a = this.stateStack[0],
        b = a.node;
    if ("&&" != b.operator && "||" != b.operator) throw SyntaxError("Unknown logical operator: " + b.operator);
...
Interpreter.prototype.stepMemberExpression = function() {
    var a = this.stateStack[0],
        b = a.node;
    a.doneObject_ ? a.doneProperty_ ? (this.stateStack.shift(), a.components ? this.stateStack[0].value = [a.object, a.value] : (b = this.getProperty(a.object, a.value)) ? b.isGetter ? (b.isGetter = !1, this.stateStack.unshift({
        node: {
            type: "CallExpression"
        },
        doneCallee_: !0,
        ...
        doneArgs_: !0,
        arguments: []
    })) : this.stateStack[0].value = b : (this.stateStack.unshift({}), this.throwException(this.TYPE_ERROR, "Cannot read property '" +
        a.value + "' of " + a.object.toString()))) : (a.doneProperty_ = !0, a.object = a.value, this.stateStack.unshift({
        node: b.property,
...
Interpreter.prototype.stepObjectExpression = function() {
    ...
    if (b.properties[d]) c ? (a.n = d + 1, this.stateStack.unshift({
        node: b.properties[d].value
    })) : (a.kind = b.properties[d].kind, this.stateStack.unshift({
        node: b.properties[d].key,
        components: !0
    })), a.valueToggle = !c;
    else {
        for (var h in a.properties) b =
            a.properties[h], "get" in b || "set" in b ? (b = {
                configurable: !0,
                enumerable: !0,
                get: b.get,
                set: b.set
...
Interpreter.prototype.stepReturnStatement = function() {
    ...
    if (b.argument && !a.done) a.done = !0, this.stateStack.unshift({
        ...
        do {
            this.stateStack.shift();
            if (0 == this.stateStack.length) throw SyntaxError("Illegal return statement");
            a = this.stateStack[0]
...
Interpreter.prototype.stepTryStatement = function() {
    var a = this.stateStack[0],
        b = a.node;
    a.doneBlock ? a.throwValue && !a.doneHandler && b.handler ? (a.doneHandler = !0, this.stateStack.unshift({
        node: b.handler,
        throwValue: a.throwValue
    }), a.throwValue = null) : !a.doneFinalizer && b.finalizer ? (a.doneFinalizer = !0, this.stateStack.unshift({
        node: b.finalizer
    })) : a.throwValue ? this.executeException(a.throwValue) : this.stateStack.shift() : (a.doneBlock = !0, this.stateStack.unshift({
        node: b.block
    }))
};
...
Interpreter.prototype.stepUpdateExpression = function() {
    ...
    if (a.doneLeft) {
        ...
        if (a.doneSetter_) this.stateStack.shift(),
            ...
            (c = this.setValue(a.leftSide, d)) ? (a.doneSetter_ = b, this.stateStack.unshift({
                node: {
                    type: "CallExpression"
                },
                doneCallee_: !0,
                ...
                doneArgs_: !0,
                arguments: [d]
            })) : (this.stateStack.shift(), this.stateStack[0].value =
                b)
        }
    } else a.doneLeft = !0, this.stateStack.unshift({
        node: b.argument,
...
Interpreter.prototype.stepVariableDeclarator = function() {
    var a = this.stateStack[0],
        b = a.node;
    b.init && !a.done ? (a.done = !0, this.stateStack.unshift({
        node: b.init
    })) : (b.init && this.setValue(this.createPrimitive(b.id.name), a.value), this.stateStack.shift())
};
